(function () {
    ...
    function injectStyles() {
        ...
        style.textContent =
            ...
            '.translationsub-head>svg{width:1.35em;height:1.35em;fill:currentColor}';
    ...
    function refreshUpdates(done) {
        ...
        request('GET', API.updates, {
            ...
            state.lastUpdates = Array.isArray(updates) ? updates : [];
            done(state.lastUpdates);
        }, function () {
            done([]);
        });
    }
    ...
    function openForItem(object) {
        try {
            if (window.TranslationSubCardFlow && typeof window.TranslationSubCardFlow.open === 'function') {
                window.TranslationSubCardFlow.open(object);
                return;
            }
        } catch (e) {}
    ...
    function refresh() {
        ...
        try {
            if (window.TranslationSubCardFlow && typeof window.TranslationSubCardFlow.refreshButton === 'function')
                window.TranslationSubCardFlow.refreshButton();
        } catch (e) {}
    }
